...
module.exports = function (app) {
  ...
  app.get("/analysis", function (req, res) {
    var one = readData("one");
    var two = readData("two");
    var three = readData("three");
    var four = readData("four");
    var five = readData("five");
    var six = readData("six");
    res.render("showResults", { results: [one, two, three, four, five, six] });
